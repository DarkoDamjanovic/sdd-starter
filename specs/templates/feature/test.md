...
_Each BDD criterion from `spec.md` must be covered by at least one test case below._

| Criterion | Test Case |
|:----------|:----------|
| **Given** {{precondition}}, **When** {{action}}, **Then** {{expected outcome}} | {{test case name or ID}} |
